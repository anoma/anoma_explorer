defmodule AnomaExplorerWeb.NullifiersLive do
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok,
     ...
     |> RealtimeHelpers.init_realtime(:nullifiers, @default_filters)}
  end
  ...
  @impl true
  def handle_info({:new_items_available, :nullifiers, meta}, socket) do
    ...
    <% else %>
      ...
      <div class="hidden lg:block overflow-x-auto">
        <table class="data-table w-full">
          <thead>
            <tr>
              <th title="Hash proving the input resource was consumed">Nullifier</th>
                  ...
                  <div class="flex flex-col gap-0.5">
                    ...
                    <%= if unit["consumedLogicRef"] do %>
                      <div class="flex items-center gap-1 text-xs text-base-content/50">
                        <span>logic:</span>
                        <code class="font-mono">{unit["consumedLogicRef"]}</code>
